...
import (
	...
	"net/http"
	"os"
	"github.com/Neha-2021/task-manager-app/models"
...
func taskComplete(tasks string){
...
func insertOneTask(tasks models.TaskList){
	insertResult, err := collection.InsertOne(context.Background(), tasks)
